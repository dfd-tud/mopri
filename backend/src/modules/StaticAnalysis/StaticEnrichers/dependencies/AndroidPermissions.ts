/*
  * SPDX-FileCopyrightText: © Androguard
  * SPDX-FileCopyrightText: © MobSF
...
/*
 * Taken from the Mobile Security Framework and converted to Typescript
 * Source file: https://github.com/MobSF/Mobile-Security-Framework-MobSF/blob/master/mobsf/StaticAnalyzer/views/android/kb/dvm_permissions.py
 */
export const AndroidPermissions: {
  MANIFEST_PERMISSION: { [key: string]: string[] };
  SPECIAL_PERMISSIONS: { [key: string]: string[] };
  MANIFEST_PERMISSION_GROUP: { [key: string]: string };
} = {
  MANIFEST_PERMISSION: {
    SEND_SMS: [
      "dangerous",
    ...
    GLOBAL_SEARCH: [
      "signatureOrSystem",
      "allows global search system to access a provider's data.",
    ...
    BIND_TEXT_SERVICE: [
      "signature",
      "required by TextServices (e.g., SpellCheckerService) for system binding.",
    ...
    READ_PHONE_NUMBERS: [
      "dangerous",
      "allows reading of the device's phone number(s).",
    ...
    SEND_RESPOND_VIA_MESSAGE: [
      "signatureOrSystem",
      "allows sending respond-via-message requests during calls.",
    ...
    WRITE_CALL_LOG: [
      "dangerous",
      "allows writing to (but not reading) the user's call log.",
    ...
    ENFORCE_UPDATE_OWNERSHIP: [
      "normal",
      "indicates intent to become the update owner via PackageInstaller.",
    ...
    MANAGE_DEVICE_POLICY_MTE: [
      "normal",
      "enables policy management for the Memory Tagging Extension.",
      "Allows an application to manage policy related to the Memory Tagging Extension (MTE).",
    ],
    MANAGE_DEVICE_POLICY_NEARBY_COMMUNICATION: [
      "normal",
      "allows policy setting for nearby communications.",
      "Allows an application to set policy related to nearby communications (e.g.Beam and nearby streaming). Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.",
    ],
    ...
    MANAGE_DEVICE_POLICY_PROFILE_INTERACTION: [
      "normal",
      "allows setting policies for interactions between user profiles.",
      "Allows an application to set policy related to interacting with profiles (e.g.Disallowing cross-profile copy and paste). Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.",
    ],
    ...
    READ_NEARBY_STREAMING_POLICY: [
      "normal",
      "allows reading nearby streaming policy settings.",
    ...
    REQUEST_COMPANION_PROFILE_APP_STREAMING: [
      "normal",
      "allows requesting association with a virtual display for app streaming.",
      "Allows application to request to be associated with a virtual display capable of streaming Android applications ( AssociationRequest.DEVICE_PROFILE_APP_STREAMING ) by CompanionDeviceManager . Not for use by third-party applications.",
    ],
    REQUEST_COMPANION_PROFILE_AUTOMOTIVE_PROJECTION: [
      "normal",
      "allows requesting association with a vehicle head unit for automotive projection.",
      "Allows application to request to be associated with a vehicle head unit capable of automotive projection ( AssociationRequest.DEVICE_PROFILE_AUTOMOTIVE_PROJECTION ) by CompanionDeviceManager . Not for use by third-party applications.",
    ],
    REQUEST_COMPANION_PROFILE_COMPUTER: [
      "normal",
      "allows requesting association with a computer for shared functionality.",
      "Allows application to request to be associated with a computer to share functionality and/or data with other devices, such as notifications, photos and media ( AssociationRequest.DEVICE_PROFILE_COMPUTER ) by CompanionDeviceManager . Not for use by third-party applications.",
    ],
    ...
    REQUEST_COMPANION_PROFILE_NEARBY_DEVICE_STREAMING: [
      "normal",
      "allows requesting to stream content to a nearby device.",
      "Allows application to request to stream content from an Android host to a nearby device ( AssociationRequest.DEVICE_PROFILE_NEARBY_DEVICE_STREAMING ) by CompanionDeviceManager . Not for use by third-party applications.",
    ],
    ...
    RUN_USER_INITIATED_JOBS: [
      "normal",
      "allows using the user-initiated jobs API.",
    ...
    SUBSCRIBE_TO_KEYGUARD_LOCKED_STATE: [
      "signature",
      "allows subscribing to the keyguard locked state.",
      "Allows an application to subscribe to keyguard locked (i.e., showing) state.",
    ],
    TURN_SCREEN_ON: [
      "normal",
      "allows turning the screen on, for use by home automation apps.",
      "Allows an app to turn on the screen on, e.g. with PowerManager.ACQUIRE_CAUSES_WAKEUP . Intended to only be used by home automation apps.",
    ],
    UPDATE_PACKAGES_WITHOUT_USER_ACTION: [
      "normal",
      "allows updating packages without requiring user action.",
    ...
    ACCESS_HIDDEN_PROFILES: [
      ...
      "Allows applications to access profiles with android.content.pm.UserProperties#PROFILE_API_VISIBILITY_HIDDEN user property, e.g. UserManager.USER_TYPE_PROFILE_PRIVATE .",
    ],
    ...
    MANAGE_DEVICE_POLICY_ASSIST_CONTENT: [
      "internal",
      "Grants an application the ability to configure policies for sharing assist content with privileged apps, such as the Assistant app.",
    ...
    MEDIA_ROUTING_CONTROL: [
      "normal",
      "Allows an application to manage the routing of media applications, restricted to use by the role COMPANION_DEVICE_WATCH.",
      "Allows an application to control the routing of media apps. Only for use by role COMPANION_DEVICE_WATCH",
    ],
    READ_DROPBOX_DATA: [
      "normal",
      "Allows an application to access data stored in Dropbox, intended exclusively for use by system-level or first-party applications, and not available for third-party applications.",
      "Allows an application to access the data in Dropbox. Not for use by third-party applications.",
    ],
    SET_BIOMETRIC_DIALOG_ADVANCED: [
      "normal",
      "Allows an application to customize BiometricDialog features, including logo and content view. Restricted to system use only.",
      "Allows an application to set the advanced features on BiometricDialog (SystemUI), including logo, logo description, and content view with more options button. Not for use by third-party applications.",
    ],
    ACCESS_ORIENTATION: [
      "normal",
  ...
  SPECIAL_PERMISSIONS: {
    ...
    "android.permission.ACCESS_ADSERVICES_TOPICS": [
      ...
      "This enables the app to retrieve information related to advertising topics or interests, which can be used for targeted advertising purposes.",
    ],
    "android.permission.ACCESS_ADSERVICES_ATTRIBUTION": [
      "normal",
      "allow applications to access advertising service attribution",
      "This enables the app to retrieve information related to advertising attribution, which can be used for targeted advertising purposes. App can gather data about how users interact with ads, such as clicks or impressions, to measure the effectiveness of advertising campaigns.",
    ],
    "android.permission.ACCESS_ADSERVICES_AD_ID": [
      "normal",
      "allow app to access the device's advertising ID.",
      "This ID is a unique, user-resettable identifier provided by Google's advertising services, allowing apps to track user behavior for advertising purposes while maintaining user privacy.",
    ],
